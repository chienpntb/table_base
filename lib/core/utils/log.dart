...
class Log {
  ...
  static void error(String? tag, String message,
    ...
    _log(tag, 'ERROR', message, '\x1B[91m',
  ...
  static void _log(String? tag, String level, String message, String color,
      {dynamic error, StackTrace? stackTrace}) {
    ...
    final location =
        '${callerFrame.uri.toString().split('/').last}:${callerFrame.line}';
